      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
        <div className="flex items-center justify-between ">
          <div className="flex items-center space-x-3 ">
            <h1 className="text-2xl font-bold text-cyan-300 tracking-wider drop-shadow-md select-none font-mono ">Tools Herd AI</h1>
          ...
          <div className="md:hidden">
            <Sheet >
              ...
              <SheetContent side="right" className="w-64 sm:w-80 bg-gradient-to-t from-cyan-400 to-slate-900 border-l border-cyan-500/20 text-slate-100">
                <SheetHeader>
                  <SheetTitle className="text-cyan-300 font-bold text-lg font-mono border">Menu</SheetTitle>
                </SheetHeader>
                <div className="mt-6 space-y-6">
                  ...
                  <Link href="/list-a-website" className="block text-slate-200 hover:text-cyan-300 font-medium  duration-200 transition-colors border">List a Website</Link>
