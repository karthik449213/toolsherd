    ...
    <main className="bg-slate-950">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-24">
        ...
        <div className="mt-12 text-slate-300 space-y-8 prose prose-lg max-w-none prose-invert">
          <h2 className="text-cyan-300 font-mono">1. Agreement to Terms</h2>
          <p>
          ...
          <h2 className="text-cyan-300 font-mono">2. Intellectual Property Rights</h2>
          <p>
          ...
          <h2 className="text-cyan-300 font-mono">3. User Representations</h2>
          <p>
          ...
          <h2 className="text-cyan-300 font-mono">4. User Submissions</h2>
          <p>
          ...
          <h2 className="text-cyan-300 font-mono">5. Third-Party Websites and Content</h2>
          <p>
          ...
          <h2 className="text-cyan-300 font-mono">6. Disclaimer</h2>
          <p>
            THE SITE IS PROVIDED ON AN AS-IS AND AS-AVAILABLE BASIS. YOU AGREE THAT YOUR USE OF THE SITE AND OUR SERVICES WILL BE AT YOUR SOLE RISK. TO THE FULLEST EXTENT PERMITTED BY LAW, WE DISCLAIM ALL WARRANTIES, EXPRESS OR IMPLIED, IN CONNECTION WITH THE SITE AND YOUR USE THEREOF, INCLUDING, WITHOUT LIMITATION, THE IMPLIED WARRANTIES OF MERCHANTABILITY, FITNESS FOR A PARTICULAR PURPOSE, AND NON-INFRINGEMENT.
          </p>

          <h2 className="text-cyan-300 font-mono">7. Limitation of Liability</h2>
          <p>
            IN NO EVENT WILL WE OR OUR DIRECTORS, EMPLOYEES, OR AGENTS BE LIABLE TO YOU OR ANY THIRD PARTY FOR ANY DIRECT, INDIRECT, CONSEQUENTIAL, EXEMPLARY, INCIDENTAL, SPECIAL, OR PUNITIVE DAMAGES, INCLUDING LOST PROFIT, LOST REVENUE, LOSS OF DATA, OR OTHER DAMAGES ARISING FROM YOUR USE OF THE SITE, EVEN IF WE HAVE BEEN ADVISED OF THE POSSIBILITY OF SUCH DAMAGES.
          </p>

          <h2 className="text-cyan-300 font-mono">8. Governing Law</h2>
          <p>
          ...
          <h2 className="text-cyan-300 font-mono">9. Contact Us</h2>
          <p>
